...
public class VenteController {
    ...
    private void ajouterVente() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/pharmacix/BoutonAccueil/AjouterVente.fxml"));
    ...
    @FXML
    private void venteTotale(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/pharmacix/BoutonAccueil/VenteTotale.fxml"));
